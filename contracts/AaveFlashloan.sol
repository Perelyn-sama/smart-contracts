...
contract AaveFlashLoan is FlashLoanReceiverBase {
    ...
    // Going to be used for what ?
    event Log(string message, uint val);

    // ILendingPoolAddressesProvider what does this represent
    ...
    function testFlashLoan(address asset, uint amount) external {
        // is IERC2O a means to 
        uint bal = IERC20(asset).balanceOf(address(this));
        require(bal < amount, "Your balance is lower than this amount");
